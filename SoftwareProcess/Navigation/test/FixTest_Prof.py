...
import uuid
import os
import Navigation.sandbox.Fix as F
import traceback
...
class TestFix(unittest.TestCase):
    ...
    def setUp(self):
        self.className = "Fix."
        self.logStartString = "Log file:"#"Log file:"
        self.logSightingString = "Sighting file:"#"Start of sighting file"
...
#            also:    writes "Log file:" to log file
#
#    Happy tests:
#        logFile:  
#            omitted  -> Fix()
...
#            
    ...
    def test100_020_ShouldConstructFixWithDefaultFile(self):
        ...
        try:
            ...
            #theLogFile.close()#added
            #print "log content ", entry
            del theLogFile
        ...
        self.assertIsInstance(theFix, F.Fix, 
                              "Major:  log file failed to create"+str(traceback.format_exc()))
...
#            nonexistent file -> setSightingFile("missing.xml")
    def test200_010_ShouldConstructWithKeywordParm(self):
        ...
        try:
            ...
            self.assertEquals(result, self.cur_path+"/CA02_200_ValidStarSightingFile.xml")
        except:
    ...
    def test200_020_ShouldSetValidSightingFile(self):
        ...
        #print "log content ",logFileContents
...
#            sighting file with invalid tag value (one of each:  date, time, observation, height, temperature, pressure, horizon)
    ...
    def test300_060_ShouldHandleNoSightings(self):       
        ...
        self.assertTrue((targetString2 in logFileContents[endOfSightingFileIndex - 2]))
        self.cleanup()   
    ...
    def test400_010_ShouldLogAngularDisplacement(self):
        expectedDiag = self.className + "getSightings:"
        self.RANDOM_LOG_FILE = "log2.txt"
        theFix = F.Fix(self.RANDOM_LOG_FILE)
        try:
            ...
            theFix.getSightings()
            self.assertEquals(result, self.cur_path+"/sightingsStar.xml")#CA02_200_ValidStarSightingFile.xml")
        except:
